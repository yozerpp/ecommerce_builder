...
public interface OrderRepository extends Repository<Order, Integer> {
    ...
    @PreAuthorize("isAuthenticated() and orderRepository.getOrdersOfCurrentUser(null).contains(new me.yusuf.ecommerce.domain.order.Order(#_id))")
    ...
    @PostAuthorize("isAuthenticated() and returnObject.userId == T(me.yusuf.ecommerce.domain.user.User).cast(principal)?.id")
