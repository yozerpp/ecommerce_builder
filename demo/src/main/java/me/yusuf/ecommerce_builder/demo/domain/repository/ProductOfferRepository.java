...
@org.springframework.stereotype.Repository("productOfferRepository")
...
public interface ProductOfferRepository extends Repository<ProductOffer, ProductOffer.ProductOfferId> {
    ...
    @PreAuthorize("isAuthenticated() and hasRole('ROLE_SELLER') and #_productSeller.getSeller().userId == T(me.yusuf.ecommerce_builder.shared.types.entity.User).cast(principal).id")
