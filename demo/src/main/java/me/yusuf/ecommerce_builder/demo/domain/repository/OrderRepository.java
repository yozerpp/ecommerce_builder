...
public interface OrderRepository extends Repository<Order, Integer> {
    ...
    @PreAuthorize("isAuthenticated() and orderRepository.getOrdersOfCurrentUser(null).contains(new me.yusuf.ecommerce_builder.shared.types.entity.Order(#_id))")
    ...
    @PostAuthorize("isAuthenticated() and returnObject.userId == T(me.yusuf.ecommerce_builder.shared.types.entity.User).cast(principal)?.id")
