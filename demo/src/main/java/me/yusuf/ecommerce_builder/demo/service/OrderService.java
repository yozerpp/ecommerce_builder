...
public class OrderService extends ServiceBase
{
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sipariş Getir")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sipariş Güncelle")
    @PreAuthorize("isAuthenticated()")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sipariş Oluştur")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sipariş İptal")
    @PreAuthorize("isAuthenticated()")
