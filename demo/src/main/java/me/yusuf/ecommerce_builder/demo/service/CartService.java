...
import me.yusuf.ecommerce_builder.demo.domain.cart.CartItemRepository;
import me.yusuf.ecommerce_builder.demo.domain.cart.CartRepository;
import me.yusuf.ecommerce_builder.demo.domain.product.ProductOffer;
import me.yusuf.ecommerce_builder.demo.domain.session.SessionRepository;
...
public class CartService extends ServiceBase {
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sepete Ekle")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sepeti Temizle")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Adet Değiştir")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sepetten Kaldır")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sepet Getir")
