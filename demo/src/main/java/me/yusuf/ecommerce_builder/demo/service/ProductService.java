...
import me.yusuf.ecommerce_builder.demo.domain.product.*;
...
public class ProductService extends ServiceBase {
    ...
    @MethodMetadataAnn(methodFriendlyName = "Teklif Oluştur")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Teklif Sil")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Teklif Güncelle")
