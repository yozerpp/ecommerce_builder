...
import me.yusuf.ecommerce_builder.demo.domain.order.OrderRepository;
...
public class ShipmentService extends ServiceBase {
    ...
    @MethodMetadataAnn(methodFriendlyName = "Sipariş Gönderi")
    @GetMapping("/order/{id}")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Gönderi Liste")
    @GetMapping
    ...
    @MethodMetadataAnn(methodFriendlyName = "Kargo Gönder")
    @PreAuthorize("hasRole('ROLE_SELLER') and T(me.yusuf.ecommerce_builder.demo.domain.user.User).cast(principal).getId().equals(#sellerId)")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Kargo İptal")
    @PreAuthorize("hasRole('ROLE_SELLER') and T(me.yusuf.ecommerce_builder.demo.domain.user.User).cast(principal).getId().equals(#sellerId)")
    ...
    @MethodMetadataAnn(methodFriendlyName = "Teslim Et")
